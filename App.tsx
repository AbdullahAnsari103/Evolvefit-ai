...
import { MuscleBook } from './components/MuscleBook'; // Imported MuscleBook
...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'dashboard': return <Dashboard user={userProfile} />;
      case 'musclebook': return <MuscleBook />; // Added MuscleBook Route
      case 'insights': return <AIInsights user={userProfile} />;
      case 'snapmeal': return <SnapMeal />;
      case 'trainer': return <AITrainer user={userProfile} />;
      case 'meal-plan': return <MealPlanPage user={userProfile} />;
      case 'workout-plan': return <WorkoutPlanPage user={userProfile} />;
